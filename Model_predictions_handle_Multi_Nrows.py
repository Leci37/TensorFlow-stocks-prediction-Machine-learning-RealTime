...
def fill_df_eval_r_with_values(arr_predit, df_eval_r, model_name):
    list_per = a_manage_stocks_dict.PERCENTAGES_SCORE
...
def predict_Multi_models(df_S, model_name, shape_imput_3d, scaler_name_file):
    ...
    x_features  = Utils_model_predict.scaler_min_max_array(arr_mul_features, path_to_load= a_manage_stocks_dict.PATH_SCALERS_FOLDER+scaler_name_file+".scal")
...
# opion = a_manage_stocks_dict.Option_Historical.MONTH_3
