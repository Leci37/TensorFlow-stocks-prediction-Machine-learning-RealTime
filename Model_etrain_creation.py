...
csv_file_SCALA = "d_price/FAV_SCALA_stock_history_MONTH_3.csv"

#TO CONFIGURE
#Columns =['Date', Y_TARGET, 'ticker'] +  MUY_BUENOS_COLUMNAS_TRAINS
#SAV_files_surname = "veryGood_16"
#TO CONFIGURE
'''Para ENTRENAR los distintos tipos de configuracion GradientBoost XGBClassifier RandomForestClassifier '''
