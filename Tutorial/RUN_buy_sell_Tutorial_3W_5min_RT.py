...
for symbol in stocks_list : #stocks_list:
    ...
    model.compile(loss=tf.keras.losses.CategoricalCrossentropy(), optimizer=Adam(lr=0.001), metrics=tf.keras.metrics.CategoricalAccuracy())
    print("[9.2] optimicer config : ", model.optimizer.get_config())
